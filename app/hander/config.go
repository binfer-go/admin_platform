...
func (*Configs) Get (req *ghttp.Request)  {
	...
	var config = g.Map{
		...
		"task_status" : 	[]g.Map{
			...
			/*{
				"name":  "删除",
				"value": server.ADMIN_TASK_STATUS_DELETE,
			},*/
		},
		...
		"user_wallet_type" : []g.Map{
			{
				"name" : "主钱包",
				"value": server.USER_WALLET_TYPE_MASTER,
			},
			{
				"name" : "佣金",
				"value": server.USER_WALLET_TYPE_COMISSION,
			},
		},
		...
		"user_action_status" : []g.Map{
			...
			{
				"name" : "永久",
				"value": server.USER_STATUS_ACTION_STEP_6,
			},
		},
		"site_config_type" : []g.Map{
			{
				"name" : "启用",
				"value": server.ADMIN_SITE_CONFIG_TYPE_STATUS_ENABLE,
			},
			{
				"name" : "禁用",
				"value": server.ADMIN_SITE_CONFIG_TYPE_STATUS_DISABLE,
			},
		},
		"site_configs_from_type" : []g.Map{
			{
				"name" : "输入框",
				"value": server.ADMIN_SITE_CONFIG_FROM_INPUT,
			},
			{
				"name" : "按钮",
				"value": server.ADMIN_SITE_CONFIG_FROM_BUTTON,
			},
			{
				"name" : "float",
				"value": server.ADMIN_SITE_CONFIG_VALUE_TYPE_FLOAT,
			},
		},
		"site_configs_value_type" : []g.Map{
			{
				"name" : "integer",
				"value": server.ADMIN_SITE_CONFIG_VALUE_TYPE_INTEGER,
			},
			{
				"name" : "string",
				"value": server.ADMIN_SITE_CONFIG_VALUE_TYPE_STRING,
			},
			{
				"name" : "float",
				"value": server.ADMIN_SITE_CONFIG_VALUE_TYPE_FLOAT,
...
func BuilderSiteConfigRedis ()  {
	...
	g.Redis().Do("HSET", redis.ADMIN_SITE_CONFIG, "site_page_max", 30)
}